...
func TestGenerate(t *testing.T) {
	Generate("https://github.com/cragus-1902/qrterminal", L, os.Stdout)
}
...
func TestGenerateWithConfig(t *testing.T) {
	...
	GenerateWithConfig("https://github.com/cragus-1902/qrterminal", config)
}

func TestGenerateHalfBlock(t *testing.T) {
	GenerateHalfBlock("https://github.com/cragus-1902/qrterminal", L, os.Stdout)
}
